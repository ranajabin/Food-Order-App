		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#bindingsample3bindingsampleproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bindingsample3bindingsampleproject3-display": {
								"semanticObject": "bindingsample3bindingsampleproject3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bindingsample3.bindingsampleproject3",
									"url": sap.ui.require.toUrl("bindingsample3/bindingsampleproject3")
								}
							}
						}
					}
